...
function setHours( t ) {
    ...
    hours.animate(
        { transform: "rotate(" + angle + " 244 251)" }, 100, mina.linear,
        function () {
    ...
    hshadow.animate( { transform: "translate(0, 2) rotate(" + angle + " " + face.cx + " " + face.cy + 2 + ")" }, 100, mina.linear );
...
function setMinutes( t ) {
    ...
    minutes.animate( { transform: "rotate(" + angle + " " + face.cx + " " + face.cy + ")" }, 100,
        mina.linear,
    ...
    mshadow.animate(
        { transform: "translate(0, 2) rotate(" + angle + " " + face.cx + " " + face.cy + 2 + ")" }, 100, mina.linear );
