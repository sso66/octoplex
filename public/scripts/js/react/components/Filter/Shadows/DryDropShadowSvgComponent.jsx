// DryDropShadowSvgComponent.jsx
console.log( " Mounting DryDropShadowSvgComponent.jsx <DryDropShadowSvgComponent />");

import React from 'react';
import IWetDropShadow from './IDryDropShadow';
...
const DryDropShadowSvgComponent = props => (
    <svg 
        ...
        <use display="none" xlinkHref="#flower" />
          
        // filtered shape object          
        <use
            display=""
            xlinkHref="#flower"
            filter="url(#drop-shadow)"
            // apply transforms and matrices
        />
    </svg>
)
