...
const EngineLoad = (props, {
    ...
    className=`svg-icon ${className || "engine-load-gauge"}`,
}) => (
    <svg 
        width={width} 
        height={height}
    ...
    >
        ...
        >
            ...
            <g 
                display=""
                className="tick-labels engine-load" 
                transform="rotate(0 18 18)">
                <text x="8" y="25">0&deg;</text>
                <text x="7"  y="14">25&deg;</text>
                <text x="18" y="6">50&deg;</text>
                <text x="29" y="14">75&deg;</text>
                <text x="28" y="25">100&deg;</text>
            </g>
...
EngineLoad.propTypes = {
}

EngineLoad.defaultProps = {
}
