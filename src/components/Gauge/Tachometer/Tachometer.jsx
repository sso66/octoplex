...
const Tachometer = (props, {
    ...
    className=`svg-icon ${className || "tachometer-gauge"}`,
}) => (
    <svg 
        width={width} 
        height={height}
    ...
    >
        ...
        >
            ...
            <g className="ticks" display="">
                ...
                <use className="tick quarterTick" href="#tick" transform="rotate(220 18 18)" />
                ...
                <use className="tick quarterTick" href="#tick" transform="rotate(320 18 18)" />
            ...
            <g  display=""
                ...
                <text x="7" y="25">0</text>
                <text x="7"  y="18.5">500</text>
                <text x="10" y="11">1000</text>
                <text x="18" y="6">1500</text>
                <text x="26" y="11">2000</text>
                <text x="29" y="18.5">2500</text>
                <text x="28" y="25">3000</text>
            </g>
