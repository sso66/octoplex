// OilPressure.jsx
console.log("Mounting OilPressure.jsx... <OilPressure />")

import React from 'react'
import LEDIndicator from '../LEDIndicator';
import ColorMatrixFilter from '../ColorMatrixFilter';
import N2KAsideTop from '../N2KAsideTop';
import './oil-pressure.sass';

const OilPressure = (props, {
    width='100%',
    height='100%',
    viewBox='0 0 400 400',
    ...
    className=`svg-icon ${className || "oil-pressure-gauge"}`,
}) => (
    <svg 
        width={width} 
        height={height}
    ...
    >
        ...
        >
            ...
            <g 
                ...
                transform="rotate(0 18 18)">
                <text x="8" y="25">0.0</text>
                <text x="7"  y="14">25.0</text>
                <text x="18" y="6">50.0</text>
                <text x="29" y="14">75.0</text>
                <text x="28" y="25">100.0</text>
            </g>
...
OilPressure.propTypes = {
}

OilPressure.defaultProps = {
}
