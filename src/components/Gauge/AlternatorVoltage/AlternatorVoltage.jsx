// AlternatorVoltage.jsx
console.log("Mounting AlternatorVoltage.jsx... <AlternatorVoltage />")

import React from 'react'
import LEDIndicator from '../LEDIndicator';
import ColorMatrixFilter from '../ColorMatrixFilter'
import N2KAsideTop from '../N2KAsideTop';
import './alternator-voltage.sass';

const AlternatorVoltage = (props, {
    width='100%',
    height='100%',
    viewBox='0 0 400 400',
    ...
    className=`svg-icon ${className || "alternator-voltage-gauge"}`,
}) => (
    <svg 
        width={width} 
        height={height}
        ...
        {...props}
    >
        <title>Alternator Voltage</title>
        ...
        >
            ...
            <g 
                display=""
                className="tick-labels alternator-voltage" 
                transform="rotate(0 18 18)">
                <text x="8" y="25">4.0</text>
                <text x="7"  y="14">9.0</text>
                <text x="18" y="6">14.0</text>
                <text x="29" y="14">19.0</text>
                <text x="27" y="25">24.0</text>
            </g>
        </svg>
...
AlternatorVoltage.propTypes = {
}

AlternatorVoltage.defaultProps = {
}

export default AlternatorVoltage
