// EngineVoltage.jsx
console.log("Mounting EngineVoltage.jsx... <EngineVoltage />")

import React from 'react'
import LEDIndicator from '../LEDIndicator';
import ColorMatrixFilter from '../ColorMatrixFilter'
import N2KAsideTop from '../N2KAsideTop';
import './engine-voltage.sass';

const EngineVoltage = (props, {
    width='100%',
    height='100%',
    viewBox='0 0 400 400',
    ...
    className=`svg-icon ${className || "engine-voltage-gauge"}`,
}) => (
    <svg 
        width={width} 
        height={height}
    ...
    >
        ...
        >
            ...
            <g 
                display=""
                className="tick-labels engine-voltage" 
                transform="rotate(0 18 18)"
            >
                <text x="8"  y="25">16.0</text>
                <text x="7"  y="14">20.0</text>
                <text x="18" y="6">24.0</text>
                <text x="29" y="14">28.0</text>
                <text x="28" y="25">32.0</text>
            </g>
...
EngineVoltage.propTypes = {
}

EngineVoltage.defaultProps = {
}

export default EngineVoltage
